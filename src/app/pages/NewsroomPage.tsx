...
const ARTICLES = [
  ...
  },
  {
    ...
    desc: "Our third manufacturing facility — 45,000 sq.ft on a 3-acre site in Maheshwaram — is now operational and accepting new programmes.",
    image: "https://images.unsplash.com/photo-1716643863806-989dd76ae093?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    featured: false,
  },
  {
    date: "APR 2026",
    ...
    <div className="bg-[#0a0a0a] pt-24">
      ...
      <section className="max-w-[1320px] mx-auto px-5 sm:px-10 lg:px-[44px] pt-14 pb-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <p className="font-['Archivo',sans-serif] text-[rgba(234,242,251,0.5)] text-sm max-w-xs">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] border border-rule overflow-hidden rounded-[4px] group cursor-pointer">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center bg-panel">
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="font-['Space_Grotesk',sans-serif] text-[#a6a6a6] text-xs tracking-[1.5px]">{featured.date}</span>
              ...
              <p className="font-['Archivo',sans-serif] text-[rgba(234,242,251,0.6)] text-sm lg:text-base leading-relaxed mb-8">
                {featured.desc}
              </p>
            ...
            <button
              ...
              className={`font-['Space_Grotesk',sans-serif] font-bold text-xs px-4 py-2 rounded-[4px] border transition-all ${
                tag === t
                  ...
                  : "border-rule text-[#a6a6a6] hover:text-white hover:border-white/20"
              }`}
            >
              {t}
            </button>
      ...
      <section className="max-w-[1320px] mx-auto px-5 sm:px-10 lg:px-[44px] pb-20">
            ...
            <article key={a.title} className="bg-[#0a0a0a] flex flex-col group cursor-pointer hover:bg-[#141414] transition-colors">
              ...
              <div className="p-6 flex flex-col flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-['Space_Grotesk',sans-serif] text-[#a6a6a6] text-[10px] tracking-[1px]">{a.date}</span>
                </div>
                <h3 className="font-['Space_Grotesk',sans-serif] font-bold text-[#eaf2fb] text-[17px] leading-snug mb-3 flex-1">
                  {a.title}
                </h3>
                <p className="font-['Archivo',sans-serif] text-[rgba(234,242,251,0.55)] text-[13px] leading-relaxed mb-5">
                  {a.desc}
                </p>
        ...
        {rest.length === 0 && (
          <div className="py-20 text-center">
            <p className="font-['Space_Grotesk',sans-serif] text-[#a6a6a6] text-sm">No articles in this category yet.</p>
          </div>
        )}
      </section>
    </div>
