...
import modelUrl from "@/imports/stabilizer-fin/base.obj?url";
import diffuseUrl from "@/imports/stabilizer-fin/texture_diffuse.png?url";
import normalUrl from "@/imports/stabilizer-fin/texture_normal.png?url";
import roughnessUrl from "@/imports/stabilizer-fin/texture_roughness.png?url";
import metallicUrl from "@/imports/stabilizer-fin/texture_metallic.png?url";

export function StabilizerFinModelViewer() {
  ...
  useEffect(() => {
    ...
    // Key — warm white from upper-left-front
